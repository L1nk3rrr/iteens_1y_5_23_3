...
def poll():
    ...
    # В базі проводимо пошук по запитанню (написати свою в файлику db.py)
    # і перевіряєм чи співпадає з value
    # Виводити користувачу на яку кількість запитань він правильно відповів (наприклад 10/12)
    ...
    # переробити thankyou.html під це все діло
